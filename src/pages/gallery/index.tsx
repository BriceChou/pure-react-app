...
import { HashRouter, Switch, Route, Link, useHistory, useLocation, useParams } from 'react-router-dom'
...
function Home() {
  return (
    <div>
      ...
      <ul>
        <li>
          <Link to="/gallery/img/2">Tomato</Link>
        </li>
        <li>
          <Link to="/gallery/img/4">Crimson</Link>
        </li>
      </ul>
    </div>
  )
